...
<div class="modal fade detail" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
						...
						<div class="form-group">
							<div class="row array" style="border-bottom: 1px solid #c9c9c9; padding-bottom: 15px;">
								...
								<div class="row">
									...
									<div class="col-xs-5">
										<input class="form-control userNameM" id="userName" name="userName"  type="text" placeholder="성명" required/>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-xs-5">
										...
										<div class="help-block with-errors pwd-errors"><span style="color:red;"></span></div>
									</div>
								...
								<div class="row">
									...
									<div class="col-xs-5">
										<input class="form-control" id="handPhone" name="handPhone" type="text" placeholder="휴대폰" required/>
									</div>
									<div class="col-xs-1 title">전화번호</div>
									<div class="col-xs-5">
										<input class="form-control" id="telNo" name="telNo" type="text" placeholder="전화번호" required/>
									</div>
								</div>
    ...
    <script src="../../share/js/checkPass.js"
	type="text/javascript"></script>
    <script>

		$('#userPw').keyup(function() {
			checkPassword('userId','userPw');
		})
