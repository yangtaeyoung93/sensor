...
<script type="text/javascript"
	src="//map.seoul.go.kr/smgis/apps/mapsvr.do?cmd=gisMapJs&key=602b16c4fd474adf90d815a063051fc3"></script>
...
AES256Util aes = new AES256Util("seoulsiDBEncrypt");
Optional<Authentication> option = Optional.ofNullable(auth);
Boolean flag = option.isPresent();
String outString = "";
String id = "";
String rid = "goL9IH7MmZ4sjS992icirA==";
Boolean script = false;
if(flag) {
	MemberDto mdto = (MemberDto) auth.getPrincipal();
	outString = aes.decrypt(mdto.getUserId());
	id = mdto.getUserId();
} else {
	script = true;
}
pageContext.setAttribute("flag", script);
...
<div id="sensor">
	<div class="loader" id="loader-1"
		style="z-index:99; position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%);"></div>
	<div class="map_wrap">
		<!-- 			센서 현황/초미세먼지/미세먼지 -->
		<div class="map-control">
			<div class="btn-group">
				<a class="leaflet-bar" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">구별 데이터 <span
						class="caret"></span></a>
		...
		<div class="modal fade goodList" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
			aria-hidden="true">
		...
		<div class="modal fade normalList" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
			aria-hidden="true">
			<div class="modal-dialog modal-lg"
				style="transform: translateY(-50%); top: 50%; padding: 20px; width: 600px;">
				<div class="modal-content" style="padding: 16px;">
		...
		<!-- BEGIN :: badList Modal -->
		<div class="modal fade badList" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
			aria-hidden="true">
			<div class="modal-dialog modal-lg"
				style="transform: translateY(-50%); top: 50%; padding: 20px; width: 600px;">
				<div class="modal-content" style="padding: 16px;">
		...
		<div class="modal fade critList" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
			aria-hidden="true">
			<div class="modal-dialog modal-lg"
				style="transform: translateY(-50%); top: 50%; padding: 20px; width: 600px;">
				<div class="modal-content" style="padding: 16px;">
